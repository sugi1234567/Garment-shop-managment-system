		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Return</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
                    ...
                    <td>
 <a href="javascript:void(0);" onClick="popUpWindow('return-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Return </a> 
                    </td>
				</tr>
<?php $cnt=$cnt+1;} ?>
